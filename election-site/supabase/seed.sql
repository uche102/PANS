...
join (
  values
    ...
    ('Who will be the next president 2027', 'Peter Obi', 'https://commons.wikimedia.org/wiki/Special:FilePath/Peter%20Obi.png', 2),
    ...
    ('Which Squid Game season is the best', 'Season 1', 'https://commons.wikimedia.org/wiki/Special:FilePath/Squid%20Game%20logo.png', 1),
    ('Which Squid Game season is the best', 'Season 2', 'https://commons.wikimedia.org/wiki/Special:FilePath/Squid%20Game%20season%202%202024%20vector%20logo.svg', 2),
